...
export PATH=/opt/kitty/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl


#-----------------------------------------------------#
source /home/andrew/powerlevel10k/powerlevel10k.zsh-theme
